...
def refocus(light_field, calib_mat, output_folder, stack_size=10):
    ...
    for idx, disparity in enumerate(disparities):
        ...
        # cv2.imwrite(output_folder,  cv2.cvtColor(image, cv2.COLOR_RGB2BGR))


if __name__ == "__main__":
    data_pth = '/data/DFF/DDFF-12_rawData/LightField/train/'
    out_pth = '/data/DFF/DDFF-12_rawData/imgs_all/train/'
    for fd in os.listdir(data_pth):
        ...
        for i, npy_pth in enumerate(npy_lst):
            ...
            refocus(npy_pth, 'IntParamLF.mat', out_pth + '/{}/{}'.format(fd, img_name) )
